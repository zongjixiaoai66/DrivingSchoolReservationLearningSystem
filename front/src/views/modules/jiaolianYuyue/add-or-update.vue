    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="jiaolianYuyueUuidNumber">
                       <el-input v-model="ruleForm.jiaolianYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.jiaolianYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="jiaolianYuyueUuidNumber">
                           <el-input v-model="ruleForm.jiaolianYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="jiaolianYuyueText">
                        <el-input type="textarea"  :readonly="ro.jiaolianYuyueText" v-model="ruleForm.jiaolianYuyueText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianYuyueText" label="报名理由" prop="jiaolianYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaolianYuyueYesnoTypes" label="报名状态" prop="jiaolianYuyueYesnoTypes">
                        <el-input v-model="ruleForm.jiaolianYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.jiaolianYuyueShenheTime" label="审核时间" prop="jiaolianYuyueShenheTime">
                        <span v-html="ruleForm.jiaolianYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '教练预约时间不能为空', trigger: 'blur' },
                          ],
                   jiaolianYuyueYesnoTypes: [
