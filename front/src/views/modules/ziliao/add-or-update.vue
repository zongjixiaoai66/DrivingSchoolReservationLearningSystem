    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学习资料名称" prop="ziliaoName">
                       <el-input v-model="ruleForm.ziliaoName"
                                 placeholder="学习资料名称" clearable  :readonly="ro.ziliaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学习资料名称" prop="ziliaoName">
                           <el-input v-model="ruleForm.ziliaoName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学习资料编号" prop="ziliaoUuidNumber">
                       <el-input v-model="ruleForm.ziliaoUuidNumber"
                                 placeholder="学习资料编号" clearable  :readonly="ro.ziliaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学习资料编号" prop="ziliaoUuidNumber">
                           <el-input v-model="ruleForm.ziliaoUuidNumber"
                                     placeholder="学习资料编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ziliaoVideo" label="学习资料视频" prop="ziliaoVideo">
                        <file-upload
                            tip="点击上传学习资料视频"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.ziliaoVideo" label="学习资料视频" prop="ziliaoVideo">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ziliaoFile" label="学习资料下载" prop="ziliaoFile">
                        <file-upload
                                tip="点击上传学习资料下载"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.ziliaoFile" label="学习资料下载" prop="ziliaoFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.ziliaoFile"  >学习资料下载下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.ziliaoContent"  label="学习资料介绍" prop="ziliaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.ziliaoContent" label="学习资料介绍" prop="ziliaoContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   ziliaoUuidNumber: [
                              { required: true, message: '学习资料编号不能为空', trigger: 'blur' },
                          ],
                   ziliaoPhoto: [
                   ...
                   ziliaoVideo: [
                              { required: true, message: '学习资料视频不能为空', trigger: 'blur' },
                          ],
                   ziliaoFile: [
                              { required: true, message: '学习资料下载不能为空', trigger: 'blur' },
                          ],
                   ziliaoContent: [
                              { required: true, message: '学习资料介绍不能为空', trigger: 'blur' },
                          ],
                   ziliaoDelete: [
